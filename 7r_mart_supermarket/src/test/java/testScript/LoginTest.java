...
public void verifyWhetherTheUserIsAbleToLoginWithCorrectUserNameAndCorrectPassword() throws IOException//it is the test case where we are giving the credentials
{
	...
	public void verifyWhetherTheUserIsAbleToLoginWithInCorrectUserNameAndInCorrectPassword() throws IOException
	{
		//String username="abcd";//credentials with wrong username and correct password
		//String password="abcd";
